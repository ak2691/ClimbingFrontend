...
export default function AdminPending() {
    ...
    useEffect(() => {
        ...
        const fetchPending = async () => {
            try {
                const res = await AuthFetch("http://localhost:8080/api/exercise-requests/admin/pending", {
                    method: 'GET',
    ...
    const submitReview = async (requestId) => {
        try {
            ...
            const res = await AuthFetch(`http://localhost:8080/api/exercise-requests/admin/${requestId}/review`, {
                method: 'POST',
                headers: {
